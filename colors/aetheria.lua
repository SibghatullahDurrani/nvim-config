...
-- nvim-tree
hl(0, 'NvimTreeNormal', { fg = colors.hex_C8E967, bg = colors.hex_0e091d })
hl(0, 'NvimTreeFolderName', { fg = colors.hex_E20342 })
hl(0, 'NvimTreeFolderIcon', { fg = colors.hex_FF7F41 })
hl(0, 'NvimTreeEmptyFolderName', { fg = colors.hex_E20342 })
hl(0, 'NvimTreeOpenedFolderName', { fg = colors.hex_E20342, bold = true })
hl(0, 'NvimTreeRootFolder', { fg = colors.hex_9147a8, bold = true })
hl(0, 'NvimTreeGitDirty', { fg = colors.hex_04C5F0 })
hl(0, 'NvimTreeGitNew', { fg = colors.hex_FF7F41 })
hl(0, 'NvimTreeGitDeleted', { fg = colors.hex_f93d3b })
